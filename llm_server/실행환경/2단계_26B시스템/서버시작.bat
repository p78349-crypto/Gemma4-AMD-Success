...
echo ================================================
echo   26B 시스템 — 서버 시작 (IQ3_S Vulkan GPU)
echo   26B GGUF :8031 + NLLB-1.3B :8012
echo   + Whisper Turbo :8021
echo ================================================
echo.

echo [1/3] Gemma4-26B GGUF (IQ3_S, Vulkan GPU) 시작...
echo       포트 8031 / 로딩 30~60초 소요
start "Gemma4-26B GGUF IQ3_S :8031" cmd /k ^
    "%PY% llama_gguf\start.py --model IQ3_S --port 8031 --ngl 99"
